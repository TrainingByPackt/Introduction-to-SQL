...
USE packt_online_shop; /*Verified - aaditya*/
...
CREATE PROCEDURE spFilterProductsByNRP /*Verified -Aaditya*/
...
CREATE PROCEDURE spCustomerOrders /*Verified Aaditya*/
...
CREATE PROCEDURE `spFilterProductsByNRP` (IN priceLevel FLOAT) /*Verfied aaditya*/
...
CREATE PROCEDURE `spFilterProductsByNRP` (IN priceLevel FLOAT) /*Verified Aaditya*/
BEGIN
...
ALTER PROCEDURE spFilterProductsByNRP /*Verified aaditya*/
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spFilterProductsByNRP`(IN priceLevel FLOAT, IN unitWeight FLOAT) /*Verified Aaditya*/
...
CREATE PROCEDURE [dbo].[spFilterOrdersByItemQuantity] /*Verified Aaditya*/
...
CREATE PROCEDURE `spFilterOrdersByItemQuantity` (IN orderItemQuantityVal int) /*Verified Aaditya*/
BEGIN
...
SELECT UPPER(@var2); # 11. Select UPPER CASE @var2 /*Verified Aaditya*/


DECLARE @custID AS INT = 3; /*Verified Aaditya on MSSQL Server*/
...
CREATE FUNCTION dbo.fnCountCustomerOrders (@CustomerID int) /*verified Aaditya*/
...
CREATE FUNCTION `fnTotalSalesRvnByCust` (CustomerID Integer) /*Verified Aaditya*/
RETURNS FLOAT
DETERMINISTIC
BEGIN
